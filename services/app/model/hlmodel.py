# exponer todos los modelos para ser importados por app.py y por los casos de usos
...
from app.model.recomendacion import Recomendacion
from app.model.recurso import Recurso
from app.model.rol import Rol
from app.model.tipoAnalisis import TipoAnalisis
from app.model.tipoCultivo import TipoCultivo
