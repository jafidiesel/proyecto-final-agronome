...
@Component({
  selector: 'app-reporte-riego',
  templateUrl: './reporte-riego.component.html'
})
export class ReporteRiegoComponent implements OnInit, OnDestroy {
  ...
  onSubmit() {
    ...
    this.subscriptions.push(
      this._reportesService.getReporteRiego(this.fechaDesde, this.fechaHasta, this.codLibroCampo).subscribe(
        result => {
